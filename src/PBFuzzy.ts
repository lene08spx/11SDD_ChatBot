...
namespace PBFuzzy {
    export const YES = ["yes please", "for sure", "sure", "sounds good", "yes", "yep", "bloody oath", "yea", "yes please"];
    export const NO  = ["nah", "no thanks", "nope", "nup", "no", "no way"];
};
export default PBFuzzy;
